...
/**
 * PasienSearch represents the model behind the search form of `app\models\DataLayanan`.
 */
class PasienSearch extends DataLayanan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = DataLayanan::find()->where(['not', ['no_registrasi' => null]])->orderBy('tanggal_pemeriksaan DESC');
