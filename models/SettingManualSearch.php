...
/**
 * SettingManualSearch represents the model behind the search form of `app\models\SettingManual`.
 */
class SettingManualSearch extends SettingManual
{
    /**
     * {@inheritdoc}
     */
