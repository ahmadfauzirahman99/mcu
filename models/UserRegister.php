...
class UserRegister extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'u_tgl_terakhir_mcu' => 'Tanggal Terakhir Mcu',
            'u_dokter' => 'Nama Dokter',
            'u_alamat_dokter' => 'Alamat Dokter',
            'u_jabatan' => 'Jabatan',
            'u_formasi' => 'Formasi',
            'u_jadwal_id' => 'Jadwal ID',
            'u_biodata_finish_at' => 'Biodata Pengisian Selesai',
            'u_berkas_finish_at' => 'Berkas Pengisian Selesai',
            'u_kuisioner1_finish_at' => 'Kuisioner 1 Selesai',
            'u_kuisioner2_finish_at' => 'Kuisioner 2 Selesai',
