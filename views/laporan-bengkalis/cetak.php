...
<body cz-shortcut-listen="true">
    <table cellspacing="0" border="0">
        <tbody>
            ...
            <tr>
                <td height="19" align="center" valign="top"><b><i> </i></b></td>
                <td align="left" valign="top"><br></td>
            ...
            <tr>
                <td height="18" align="left" valign="top"><br></td>
                <td rowspan="1" colspan="3" align="left" valign="top">Atas Permintaan &nbsp;&nbsp; : PEMERIKSAAN MCU CPNS MENJADI PNS KABUPATEN BENGKALIS </td>
            </tr>
            <tr>
                <td height="20" align="left" valign="bottom"><br></td>
                <td align="left" valign="bottom"><br></td>
            ...
            <tr>
                <td height="18" align="left" valign="top"><br></td>
                <td rowspan="1" colspan="3" align="left" valign="top">Maksud Ujian &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : BKPP KABUPATEN BENGKALIS</td>
            </tr>
            <tr>
                <td height="18" align="left" valign="bottom"><br></td>
                <td align="left" valign="bottom"><br></td>
            ...
            <tr>
                ...
                <td align="left" valign="bottom"><br></td>
                <td align="left" valign="top">Pekerjaan Sekarang </td>
                <!--u_jabatan_pekerjaan-->
            ...
            <tr>
                ...
                <td align="left" valign="top">: <?= $modelDataLayanan->status_perkawinan == "Duda" ? "Ya" : "-" ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Anak : <?= $modelAnamnesis->h ?></td>
            </tr>
            <tr>
    ...
    <body cz-shortcut-listen="true">
        <table cellspacing="0" border="0">
            <tbody>
                ...
                <tr>
                    <td height="18" align="left" valign="top">UKURAN 2 :</td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                ...
                <tr>
                    ...
                    <?php if ("Cukup" == $modelPemeriksaanDokterBengkalis->kecerdasan) {
                        $kecerdasan = "&nbsp;&nbsp;&nbsp;CUKUP&nbsp;&nbsp;&nbsp;</span><br><s>KURANG</s>";
                    } ?>
                    <?php if ("Kurang" == $modelPemeriksaanDokterBengkalis->kecerdasan) {
                        $kecerdasan = "&nbsp;&nbsp;&nbsp;<s>CUKUP</s>&nbsp;&nbsp;&nbsp;</span><br>KURANG";
                    } ?>
                    <?php $sehat = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br> <s>Kurang Sehat</s>"; ?>
                    <?php if ("SEHAT" == $modelPemeriksaanDokterBengkalis->sehat) {
                        $sehat = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br> <s>Kurang Sehat</s>";
                    } ?>
                    <?php if ("KURANG SEHAT" == $modelPemeriksaanDokterBengkalis->sehat) {
                        $sehat = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s>Sehat</s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br> Kurang Sehat";
                    } ?>
                ...
                <tr>
                    ...
                    <?php if ("BIASA" == $modelPemeriksaanDokterBengkalis->keliatan_muda) {
                        $keliatan_muda = '&nbsp;&nbsp;&nbsp;<s>Muda</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;Biasa&nbsp;&nbsp;&nbsp;</span><br><s>Tua</s>';
                    } ?>
                    <?php if ("MUDA" == $modelPemeriksaanDokterBengkalis->keliatan_muda) {
                        $keliatan_muda = '&nbsp;&nbsp;&nbsp;Muda&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br><s>Tua</s>';
                    } ?>
                    <?php if ("TUA" == $modelPemeriksaanDokterBengkalis->keliatan_muda) {
                        $keliatan_muda = '&nbsp;&nbsp;&nbsp;<s>Muda</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br>Tua';
                    } ?>
                    ...
                    <?php if ("BIASA" == $tegapnya) {
                        $tegap = '<span class="underline">&nbsp;&nbsp;&nbsp;<s>Tegap</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;Biasa&nbsp;&nbsp;&nbsp;</span><br><s>Kurus</s>';
                    } ?>
                    <?php if ("TEGAP" == $tegapnya) {
                        $tegap = '<span class="underline">&nbsp;&nbsp;&nbsp;Tegap&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br><s>Kurus</s>';
                    } ?>
                    <?php if ("KURUS" == $tegapnya) {
                        $tegap = '<span class="underline">&nbsp;&nbsp;&nbsp;<s>Tegap</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br>Kurus';
                    } ?>

                    <?php $gemuk = '<span class="underline">&nbsp;&nbsp;&nbsp;<s>Gemuk</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;Biasa&nbsp;&nbsp;&nbsp;</span><br><s>Kurus</s>'; ?>
                    <?php if ("BIASA" == $tegapnya) {
                        $gemuk = '<span class="underline">&nbsp;&nbsp;&nbsp;<s>Gemuk</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;Biasa&nbsp;&nbsp;&nbsp;</span><br><s>Kurus</s>';
                    } ?>
                    <?php if ("TEGAP" == $tegapnya) {
                        $gemuk = '<span class="underline">&nbsp;&nbsp;&nbsp;Gemuk&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br><s>Kurus</s>';
                    } ?>
                    <?php if ("KURUS" == $tegapnya) {
                        $gemuk = '<span class="underline">&nbsp;&nbsp;&nbsp;<s>Gemuk</s>&nbsp;&nbsp;&nbsp;</span><br> <span class="underline">&nbsp;&nbsp;&nbsp;<s>Biasa</s>&nbsp;&nbsp;&nbsp;</span><br>Kurus';
                    } ?>
                ...
                <tr>
                    <td height="18" align="left" valign="bottom">MATA : </td>
                    <td align="left" valign="top">Ketajaman Penglihatan</td>
                    <td align="left" valign="bottom">: Kanan (<?= $modelPemeriksaanFisik->mata_gerak_bola_mata_kanan ?>)</td>
                ...
                <tr>
                    <td height="18" align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"> &nbsp; Kiri (<?= $modelPemeriksaanFisik->mata_gerak_bola_mata_kiri ?>)</td>
                    <td align="left" valign="bottom"><br></td>
                ...
                <tr>
                    ...
                    <td align="left" valign="bottom">: Kanan (-) </td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="top"> &nbsp; Kiri (<?= $modelPemeriksaanFisik->mata_gerak_bola_mata_kiri ?>)</td>
                    <td align="left" valign="bottom"><br></td>
                </tr>
                <tr>
                    <td height="18" align="left" valign="bottom"><br></td>
                    ...
                    <td align="left" valign="top">: Kanan (<?= $modelPemeriksaanFisik->mata_persepsi_warna_kanan ?>) <br> &nbsp; Kiri (<?= $modelPemeriksaanFisik->mata_persepsi_warna_kiri ?>)</td>
                    <td align="left" valign="bottom"><br></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" colspan="3" valign="bottom">Kanan (<?= $modelMcuSpesialisThtBerbisik->tl_test_berbisik_telinga_kanan ?>)</td>
                </tr>
                <tr>
                    <td height="18" align="left" valign="bottom"><br></td>
                    ...
                    <td align="left" colspan="3" valign="bottom">Kiri (<?= $modelMcuSpesialisThtBerbisik->tl_test_berbisik_telinga_kiri ?>)</td>
                </tr>
                <tr>
                    <td height="18" align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                ...
                <tr>
                    <td height="18" align="left" colspan="2" valign="top">PERUT : Periksa-raba (palpatio) : <?= $modelPemeriksaanFisik->genitourinaria_prostat ?></td>
                ...
                <tr>
                    <td height="18" align="center" colspan="2" valign="top">Setoum : Hydrocele? <?= $modelPemeriksaanFisik->hydrocele ?></td>
                    <td align="left" valign="bottom"> Varicocele ? <?= $modelPemeriksaanFisik->genitourinaria_genitalia_eksternal == "Tidak Normal" ? "Tidak Normal" : $modelPemeriksaanFisik->varicocele ?> </td>
                    <td align="left" colspan="3" valign="bottom">Penis : Ulcera ? <?= $modelPemeriksaanFisik->genitourinaria_genitalia_eksternal == "Tidak Normal" ? "Tidak Normal" : $modelPemeriksaanFisik->ulceral ?></td>
                </tr>
                <tr>
                    <td height="18" align="right" valign="top">Gonorchoea? <?= $modelPemeriksaanFisik->genitourinaria_genitalia_eksternal == "Tidak Normal" ? "Tidak Normal" : $modelPemeriksaanFisik->gonorchoea ?> </td>
                    <td align="left" valign="bottom"><br></td>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 1px solid #000000" align="left" valign="bottom"> Gerak biasa ? <?= $modelPemeriksaanFisik->tingkat_kesadaran_gangguan_saat_berjalan ?></td>
                    <td style="border-bottom: 1px solid #000000" align="left" valign="bottom"><br></td>
                    <td style="border-bottom: 1px solid #000000" align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                </tr>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #000000" height="18" align="left" colspan="3" valign="top">PEMERIKSAAN TINJA (feses) : -</td>
                    <td style="border-bottom: 1px solid #000000" align="left" valign="bottom"><br></td>
                    <td style="border-bottom: 1px solid #000000" align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                </tr>
                <tr>
                    <td colspan="2" height="36" align="left" valign="middle">CATATAN-CATATAN ISTIMEWA ATAU PERATURAN ISTIMEWA</td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                ...
                <tr>
                    <td colspan="2" height="36" align="left" valign="top"><?= $istimewa ?><br><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
                    <td align="left" valign="bottom"><br></td>
        ...
        <body cz-shortcut-listen="true">
            <table cellspacing="0" border="0">
                <tbody>
                    <tr>
                        <td colspan="3" rowspan="2" height="37" align="left" valign="middle"><b>DAPATKAH KELAINAN-KELAINAN YANG MUNGKIN TERDAPAT DIPERBAIKI DAN BAGAIMANA CARANYA ?</b></td>
                        <td align="left" valign="bottom"><br></td>
                    </tr>
                    <tr>
                        <td align="left" valign="bottom"> <br></td>
                    ...
                    <tr>
                        <td colspan="3" height="18" align="left" valign="top">
                            <?php if ($modelMcuPenatalaksanaanMcu->jenis_permasalahan != null || $modelMcuPenatalaksanaanMcu->jenis_permasalahan != "") { ?>
                    ...
                    <tr>
                        <td style="border-top: 1px solid #000000; font-size:16px;" colspan="4" height="18" align="center" valign="middle"><br><b>PEMBEDAAN</b></td>
                    </tr>
                    <tr>
                        <td height="18" align="center" valign="middle"><br></td>
                        <td align="left" valign="bottom"><br></td>
                        <td align="left" valign="bottom"><br></td>
                        <td align="left" valign="bottom"><br></td>
                    </tr>
                    ...
                    <tr>
                        <td height="18" align="left" colspan="2" valign="top">CATATAN: Terangkan sejelas-jelasnya apa pertimbangan yang menyebabkan perbedaan ini :</td>
                        <td align="left" valign="bottom"><br></td>
                        <td align="left" valign="bottom"><br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="18" align="left" valign="bottom"><br></td>
                        <td align="left" valign="bottom"><br></td>
                        <td align="left" valign="top"><b>TANDA TANGAN : </b></td>
                        <td align="left" valign="bottom"><b>TANGGAL</b></td>
                    </tr>
                    <tr>
                        <td height="18" align="left" colspan="2" valign="top">1.Ketua &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: dr.MARDIANSYAH KUSUMA Sp.Ok</td>
                        <td colspan="4" align="left" valign="bottom">.....................................&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= LaporanBengkalisController::tglIndo(date('d-m-Y', strtotime($modelDataLayanan->tanggal_pemeriksaan))) ?><br></td>
                    </tr>
                    <?php
                    $no = 2;
                    ...
                    <tr>
                        <td height="18" align="left" valign="top"><br></td>
                        <td align="left" valign="bottom"><br></td>
                        <td style="padding-right:-100px" colspan="2" rowspan="2" align="center" valign="middle">Hasil perneriksaan asli dikirimkan kepada : <br> &nbsp;&nbsp; Menteri Kesehatan, Untuk perhatiannya : <br> Kepala Biro Kepegawaian</td>
                    </tr>
                    <tr>
                        <td height="18" align="left" valign="top"><br></td>
                        <td align="left" valign="bottom"><br></td>
                    ...
                    <tr>
                        <!-- <td align="left" valign="bottom"><br></td> -->
                        <td style="padding-right:-280px" align="left" valign="top" align="center">Pada tanggal <?= LaporanBengkalisController::tglIndo(date('d-m-Y')) ?> </td>
                    </tr>
                    <tr>
