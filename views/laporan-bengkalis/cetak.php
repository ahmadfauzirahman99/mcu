...
<table cellspacing="0" border="0">
    ...
    <tr>
        <td height="18" align="left" valign="top"><br></td>
        <td rowspan="1" colspan="3" align="left" valign="top">Atas Permintaan &nbsp;&nbsp; : Badan Kepegawaian Daerah Provinsi Riau<?php strtoupper($modelRegister->u_tempat_tugas) ?> </td>
    </tr>
    <tr>
        <td height="20" align="left" valign="bottom"><br></td>
        <td align="left" valign="bottom"><br></td>
    ...
    <tr>
        <td height="18" align="left" valign="top"><br></td>
        <td rowspan="1" colspan="3" align="left" valign="top">Maksud Ujian &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : PEMERIKSAAN KELAIKAN KERJA ASN </td>
    </tr>
    <tr>
        <td height="18" align="left" valign="bottom"><br></td>
        <td align="left" valign="bottom"><br></td>
...
<table cellspacing="0" border="0">
    ...
    <tr>
		...
		<?=$modelPembedaan?$modelPembedaan->noted_sp:"";?>						
...
<table style="page-break-inside: avoid" cellspacing="0" border="0">
	...
	<?php
		...
		$jabatannya=$modelRegister['u_jabatan']!=null?$modelRegister['u_jabatan']:$modelRegisterdaftar['ud_jabatan_pekerjaan'];
		$tempatnya=$modelRegister['u_tempat_tugas']!=null?$modelRegister['u_tempat_tugas']:$modelRegisterdaftar['ud_alamat_pekerjaan'];
		// var_dump($modelRegisterdaftar['ud_jabatan_pekerjaan']);exit;
		 // var_dump($modelRegisterdaftar['ud_alamat_pekerjaan']);exit;
	?>
    <tr>
        <td height="18" colspan="4" align="left" valign="top" style="font-size:14px;"><?=strtoupper($fitnya)?> SEBAGAI <?=strtoupper($jabatannya) ?> DI <?=strtoupper($tempatnya) ?><br></td>
    </tr>
    <tr>
