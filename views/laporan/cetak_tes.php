...
<div class="row" style="height: 800px;margin:30px 30px 0px 30px">
    <div class="col-md-12" style="border: 1px solid; height:100%">
        <!-- data pribadi -->
        <!-- tinggal isinya -->
        <table width="100%" border="1" cellpadding="1" cellspacing="0" style="border-collapse:collapse;text-align:left;font-size:12px">
            <tr>
                    ...
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-bottom-color:#fff;border-collapse:collapse;text-align:left;font-size:12px">
                        ...
                        <tr>
                            ...
                            <td style="width:72%;height:10px">
                                ...
                                <?php if ($data_pelayanan->kode_debitur == "0129" ||  $data_pelayanan->kode_debitur == "0130") { ?>
                ...
                <td>
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-top-color:#fff;border-collapse:collapse;text-align:left;font-size:12px">
                        ...
                        <tr>
                            ...
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->persepsi_warna_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->persepsi_warna_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">b. Kelopak Mata</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->kelopak_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->kelopak_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">c. Konjungtiva</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->konjungtiva_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->konjungtiva_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">d. Kesegarisan</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->kesegarisan_gerak_bola_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->kesegarisan_gerak_bola_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">e. Sklera</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->skiera_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->skiera_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">f. Lensa Mata</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->lensa_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->lensa_mata_kiri ?></td>
                        </tr>
                        <tr>
                            <td style="width:25%">g. Kornea</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->kornea_mata_kanan?></td>
                            <td style="width:37%"><?= $mata->kornea_mata_kiri ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->tekanan_bola_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->tekanan_bola_mata_kiri ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->virus_mata_tanpa_koreksi_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->virus_mata_tanpa_koreksi_mata_kiri ?></td>
                      
                        </tr>
                        <tr>
                            <td style="width:25%"> - Dengan Koreksi</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->virus_mata_dengan_koreksi_mata_kanan ?></td>
                            <td style="width:37%"><?= $mata->virus_mata_dengan_koreksi_mata_kiri ?></td>
                        </tr>
                            <tr>
                            <td style="width:25%">k. Kesan</td>
                            <td style="width:1%">:</td>
                            <td style="width:37%"><?= $mata->kesan ?></td>
                            <td style="width:37%"></td>
                        </tr>
                    </table>
                </td>
...
<div class="row" style="height:800px">
    ...
    <div class="col-md-12" style="margin:0px 30px 0px 30px;border: 1px solid;height:100%">
                ...
                <td>
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-top-color:#fff;border-collapse:collapse;text-align:left;font-size:12px">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td style="width:30%">c. Test Berbisik</td>
                            <td style="width:1%">:</td>
                            <td style="width:34.5%"><?= $testBerbisik->tl_test_berbisik_telinga_kanan ?? '-' ?></td>
                            <td style="width:34.5%"><?= $testBerbisik->tl_test_berbisik_telinga_kiri ?? '-' ?></td>
                        </tr>
        ...
        <b style="font-size:12px">10. Gigi</b>
         <table width="100%" border="1" cellpadding="1" cellspacing="0" style="border-bottom-color:#fff;border-collapse:collapse;text-align:left;font-size:12px;margin: 10px">
             <thead>
                <tr>
                    <th style="font-size: 12px; padding: 2px;" colspan="2">KETERANGAN</th>
                    <th style="font-size: 12px; padding: 2px;" colspan="2">KETERANGAN</th>
                </tr>
            </thead>
            <tbody>
        ...
        <tbody>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->oklusi == 'Normal Bite') ? $gigi->oklusi : '<span style="text-decoration: line-through;"> Normal Bite </span>';
                    echo ' / ';
                    echo ($gigi->oklusi == 'Cross Bite') ? $gigi->oklusi : '<span style="text-decoration: line-through;"> Cross Bite </span>';
                    echo ' / ';
                    echo ($gigi->oklusi == 'Steep Bite') ? $gigi->oklusi : '<span style="text-decoration: line-through;"> Steep Bite </span>';
                    if ($gigi->oklusi != 'Normal Bite' && $gigi->oklusi != 'Cross Bite' && $gigi->oklusi != 'Steep Bite') {
                        echo ' / ';
                        echo $gigi->oklusi;
                    }
                    ?>
            ...
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->torus_palatinus == 'Tidak Ada') ? $gigi->torus_palatinus : '<span style="text-decoration: line-through;"> Tidak Ada </span>';
                    echo ' / ';
                    echo ($gigi->torus_palatinus == 'Kecil') ? $gigi->torus_palatinus : '<span style="text-decoration: line-through;"> Kecil </span>';
                    echo ' / ';
                    echo ($gigi->torus_palatinus == 'Sedang') ? $gigi->torus_palatinus : '<span style="text-decoration: line-through;"> Sedang </span>';
                    echo ' / ';
                    echo ($gigi->torus_palatinus == 'Besar') ? $gigi->torus_palatinus : '<span style="text-decoration: line-through;"> Besar </span>';
                    echo ' / ';
                    echo ($gigi->torus_palatinus == 'Multiple') ? $gigi->torus_palatinus : '<span style="text-decoration: line-through;"> Multiple </span>';
                    if ($gigi->torus_palatinus != 'Tidak Ada' && $gigi->torus_palatinus != 'Kecil' && $gigi->torus_palatinus != 'Sedang' && $gigi->torus_palatinus != 'Besar' && $gigi->torus_palatinus != 'Multiple') {
                        echo ' / ';
                        echo $gigi->torus_palatinus;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->torus_mandibularis == 'Tidak Ada') ? $gigi->torus_mandibularis : '<span style="text-decoration: line-through;"> Tidak Ada </span>';
                    echo ' / ';
                    echo ($gigi->torus_mandibularis == 'Sisi Kiri') ? $gigi->torus_mandibularis : '<span style="text-decoration: line-through;"> Sisi Kiri </span>';
                    echo ' / ';
                    echo ($gigi->torus_mandibularis == 'Sisi Kanan') ? $gigi->torus_mandibularis : '<span style="text-decoration: line-through;"> Sisi Kanan </span>';
                    echo ' / ';
                    echo ($gigi->torus_mandibularis == 'Kedua Sisi') ? $gigi->torus_mandibularis : '<span style="text-decoration: line-through;"> Kedua Sisi </span>';
                    if ($gigi->torus_mandibularis != 'Tidak Ada' && $gigi->torus_mandibularis != 'Sisi Kiri' && $gigi->torus_mandibularis != 'Sisi Kanan' && $gigi->torus_mandibularis != 'Kedua Sisi') {
                        echo ' / ';
                        echo $gigi->torus_mandibularis;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->palatum == 'Tinggi') ? $gigi->palatum : '<span style="text-decoration: line-through;"> Tinggi </span>';
                    echo ' / ';
                    echo ($gigi->palatum == 'Sedang') ? $gigi->palatum : '<span style="text-decoration: line-through;"> Sedang </span>';
                    echo ' / ';
                    echo ($gigi->palatum == 'Rendah') ? $gigi->palatum : '<span style="text-decoration: line-through;"> Rendah </span>';
                    if ($gigi->palatum != 'Tinggi' & $gigi->palatum != 'Sedang' & $gigi->palatum != 'Rendah') {
                        echo ' / ';
                        echo $gigi->palatum;
                    }
                    ?>
            ...
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->supernumerary_teeth == 'Tidak Ada') ? $gigi->supernumerary_teeth : '<span style="text-decoration: line-through;"> Tidak Ada </span>';
                    echo ' / ';
                    echo ($gigi->supernumerary_teeth == 'Ada') ? $gigi->supernumerary_teeth : '<span style="text-decoration: line-through;"> Ada </span>';
                    if ($gigi->supernumerary_teeth != 'Tidak Ada' && $gigi->supernumerary_teeth != 'Ada') {
                        echo ' / ';
                        echo $gigi->supernumerary_teeth;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->diastema == 'Tidak Ada') ? $gigi->diastema : '<span style="text-decoration: line-through;"> Tidak Ada </span>';
                    echo ' / ';
                    echo ($gigi->diastema == 'Ada') ? $gigi->diastema : '<span style="text-decoration: line-through;"> Ada </span>';
                    if ($gigi->diastema != 'Tidak Ada' && $gigi->diastema != 'Ada') {
                        echo ' / ';
                        echo $gigi->diastema;
                    }
                    ?>
            ...
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->spacing == 'Tidak Ada') ? $gigi->spacing : '<span style="text-decoration: line-through;"> Tidak Ada </span>';
                    echo ' / ';
                    echo ($gigi->spacing == 'Ada') ? $gigi->spacing : '<span style="text-decoration: line-through;"> Ada </span>';
                    if ($gigi->spacing != 'Tidak Ada' && $gigi->spacing != 'Ada') {
                        echo ' / ';
                        echo $gigi->spacing;
                    }
                    ?>
            ...
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->oral_hygiene == 'Baik') ? $gigi->oral_hygiene : '<span style="text-decoration: line-through;"> Baik </span>';
                    echo ' / ';
                    echo ($gigi->oral_hygiene == 'Sedang') ? $gigi->oral_hygiene : '<span style="text-decoration: line-through;"> Sedang </span>';
                    echo ' / ';
                    echo ($gigi->oral_hygiene == 'Kurang') ? $gigi->oral_hygiene : '<span style="text-decoration: line-through;"> Kurang </span>';
                    if ($gigi->oral_hygiene != 'Baik' && $gigi->oral_hygiene != 'Sedang' && $gigi->oral_hygiene != 'Kurang') {
                        echo ' / ';
                        echo $gigi->oral_hygiene;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->gingiva_periodontal == 'Normal') ? $gigi->gingiva_periodontal : '<span style="text-decoration: line-through;"> Normal </span>';
                    echo ' / ';
                    echo ($gigi->gingiva_periodontal == 'Gingivitis') ? $gigi->gingiva_periodontal : '<span style="text-decoration: line-through;"> Gingivitis </span>';
                    echo ' / ';
                    echo ($gigi->gingiva_periodontal == 'Periodontitis') ? $gigi->gingiva_periodontal : '<span style="text-decoration: line-through;"> Periodontitis </span>';
                    if ($gigi->gingiva_periodontal != 'Normal' && $gigi->gingiva_periodontal != 'Gingivitis' && $gigi->gingiva_periodontal != 'Periodontitis') {
                        echo ' / ';
                        echo $gigi->gingiva_periodontal;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->oral_mucosa == 'Normal') ? $gigi->oral_mucosa : '<span style="text-decoration: line-through;"> Normal </span>';
                    echo ' / ';
                    echo ($gigi->oral_mucosa == 'Disease') ? $gigi->oral_mucosa : '<span style="text-decoration: line-through;"> Disease </span>';
                    if ($gigi->oral_mucosa != 'Normal' && $gigi->oral_mucosa != 'Disease') {
                        echo ' / ';
                        echo $gigi->oral_mucosa;
                    }
                    ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="col-3">
                    <?php
                    echo ($gigi->tongue == 'Normal') ? $gigi->tongue : '<span style="text-decoration: line-through;"> Normal </span>';
                    echo ' / ';
                    echo ($gigi->tongue == 'Disease') ? $gigi->tongue : '<span style="text-decoration: line-through;"> Disease </span>';
                    if ($gigi->tongue != 'Normal' && $gigi->tongue != 'Disease') {
                        echo ' / ';
                        echo $gigi->tongue;
                    }
                    ?>
...
<div style="height: 800px;margin:0px 30px 0px 30px;">
        <!-- data pribadi -->
        <!-- tinggal isinya -->
        <table width="100%" border="1" cellpadding="1" cellspacing="0" style="border-collapse:collapse;text-align:left;font-size:12px">
            <tr>
...
<div class="row" style="height:800px">
    ...
    <div class="col-md-12" style="margin:0px 30px 0px 30px;border: 1px solid;">
     ...
     <?php
        ...
        // $mataKesan = json_decode($kelainan->hasil);
        // $mataKelainan = "";
                ...
                <td>
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse;text-align:left;font-size:12px">
                        <tr>
                            ...
                            <td style="width:68.5%">
                                <?php
                                   if($mata->kesan == 'Tidak Normal'){
                                     foreach($kelainan->mata as $item){
                                        if($item->result == 1){
                                            echo "<b>" .$mata->getAttributeLabel($item->item)."</b>"." = " . $item->value . "<br>";
                                          // $mataKelainan .=  $mata->getAttributeLabel($items->item);
                                            // $mataKelainan =. " ( ". $mata->getAttributeLabel($items->item) . " ".$item->value . " ) ";
                                        }
                                    }
                                   }
                                 ?>
