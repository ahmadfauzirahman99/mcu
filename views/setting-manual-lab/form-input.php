...
?>
    ...
    <div class="modal-dialog modal-lg" role="document" style="margin-top: 0px;">
        <div class="modal-content">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <label class="control-label">Item Labs</label>
                </div>
                <div class="col-sm-8">
                    <?=
                    $form->field($model, 'id_item_lab')->label(false)->widget(\kartik\select2\Select2::classname(), [
                        'options'=>['id'=>'DataItemLabs'],
                        'data' => ArrayHelper::map(\app\models\McuItemLab::getListItemLab(),'id_item_lab','nama_item_lab'),
                        'pluginOptions'=>[
                            'placeholder'=>'Pilih Item Labs ....',
                            'allowClear' => true
                        ],
                    ]);
                    ?>
...
$this->registerJs(" 
     ...
     $('.btn-save').click(function(e){
            e.preventDefault();
            var btn=$('.btn-save');
            var Data = $('#McuSettingManualLab').serialize();
