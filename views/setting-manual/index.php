...
<div class="site-about">
    ...
    <?php
    $url = \yii\helpers\Url::to(['/setting-manual/get-data-pelayanan']);
    // $model->icdt10 = "";
...
<div class="card-box pb-0">
    ...
    <div id="progressbarwizard" class="pull-in">
        <ul class="nav nav-tabs nav-justified">
            ...
            <li class="nav-item"><a href="#profile-tab-2" data-toggle="tab" class="nav-link">SETTING HASIL</a></li>
            <li class="nav-item"><a href="#finish-2" data-toggle="tab" class="nav-link"> DATA SETTING MANUAL</a></li>
        </ul>
        ...
        <div class="tab-content b-0 mb-0">
            ...
            <div class="tab-pane p-t-10 fade" id="profile-tab-2">
                <?= $this->render('setting-manual.php', []) ?>
            </div>
            <div class="tab-pane p-t-10 fade" id="finish-2">
                <?= $this->render('data-manual.php', []) ?>
            </div>
