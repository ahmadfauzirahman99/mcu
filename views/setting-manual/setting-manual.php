<div class="setting-manual-form">
    <div class="row">
        ...
        data-toggle="tooltip" onclick="FormInputManual()" data-placement="bottom" data-original-title="Input Data Manual" style="cursor: pointer">
    ...
    <div class="table-rep-plugin">
        <div class="table-responsive" data-pattern="priority-columns">
            <table id="tech-companies-1" class="table  table-striped">
                <thead>
                    <tr>
                        <th width="35%">Kategori Pemeriksaan</th>
...
function FormInputManual() {
    ...
    if (typeof NoRegistrasi != 'undefined' && NoRegistrasi != '') {
        $.ajax({
            url: '<?= Yii::$app->urlManager->createUrl('setting-manual/form-input') ?>',
...
function RefreshManual() {
    ...
    if (typeof NoRegistrasi != 'undefined' && NoRegistrasi != '') {
        $.ajax({
            url: '<?= Yii::$app->urlManager->createUrl('setting-manual/refresh-manual') ?>',
