 ...
 * @Last Modified time: 2020-10-08 21:40:42
 */


$(document).ready(function () {

    $('#mcuspesialisthtberbisik-kesimpulan').on('change', function (e) {
        let kesimpulan = $('#McuSpesialisThtBerbisik_kesimpulan_0').prop('checked')
