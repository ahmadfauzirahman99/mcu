 ...
 * @Last Modified time: 2020-11-28 15:16:48
 */
...
$(document).ready(function () {
    ...
    $('#mcuspesialistht-tl_test_garpu_tala_periksa').on('change', function (e) {
        let tl_test_garpu_tala_periksa = $('#McuSpesialisTht_tl_test_garpu_tala_periksa_0').prop('checked')
    ...
    $('#mcuspesialistht-tl_test_berbisik_periksa').on('change', function (e) {
        let tl_test_berbisik_periksa = $('#McuSpesialisTht_tl_test_berbisik_periksa_0').prop('checked')
    ...
    $('#mcuspesialistht-tl_audiometri_periksa').on('change', function (e) {
        let tl_audiometri_periksa = $('#McuSpesialisTht_tl_audiometri_periksa_0').prop('checked')
