...
$this->title = 'UNIT LABORATORIUM PATOLOGI KLINIK RSUD ARIFIN ACHMAD PROVINSI RIAU';
...
<div class="site-about">
    ...
    <?php
    $url = \yii\helpers\Url::to(['/unit-lab-pk/get-data-pelayanan']);
    // $model->icdt10 = "";
...
<div class="card-box pb-0">
    ...
    <h4 class="header-title m-t-0 m-b-30">Hasil Laboratorium Klinik</h4>
