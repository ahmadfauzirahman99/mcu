...
<div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-4">
            <?= $form->field($jenisPekerjaan, 'jenis_pekerjaan')->textarea(['rows' => 1]) ?>
        </div>
        <div class="col-lg-4">
            <?= $form->field($jenisPekerjaan, 'bahan_material')->textarea(['rows' => 1]) ?>
        </div>
        <div class="col-lg-4">
            <?= $form->field($jenisPekerjaan, 'tempat_kerja')->textarea(['maxlength' => true, 'rows' => 1]) ?>
        </div>
        <div class="col-lg-12">
            <?= $form->field($jenisPekerjaan, 'masa_kerja')->textarea(['maxlength' => true, 'rows' => 1]) ?>
        </div>
        <div class="col-lg-12">
            ...
            <?= $form->field($jenisPekerjaan, 'no_daftar')->hiddenInput(['maxlength' => true, 'value' => $dataLayanan->no_registrasi, 'readonly' => true])->label(false) ?>
        </div>
    </div>
